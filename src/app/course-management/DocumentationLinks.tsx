	...
	return (
		<>
			{process.env.NEXT_PUBLIC_EXPERIMENTAL_FEATURES?.split(",").includes(
				...
				<div className='card bg-primary text-primary-content p-10 w-full mx-auto mb-5 font-mono grid grid-cols-1 rounded-lg shadow-white shadow-sm'>
					...
					<div className='col-span-1'>
						...
						<ul className='text-sm uppercase'>
							<li className='py-1'>
								<a href='https://www.npmjs.com/package/@andamiojs/core'>
									NPM Package
								</a>
							</li>
							<li className='py-1'>
					...
					<div className='col-span-1'>
						...
						<ul className='text-sm uppercase'>
							<li className='py-1'>
								<Link href='https://www.andamio.io/course/module/101/overview'>
									Module 101: How to Learn in Andamio
								</Link>
							</li>
							<li className='py-1'>
								<Link href='https://www.andamio.io/course/module/201/overview'>
									Module 201: How to Teach With Andamio
								</Link>
							</li>
						</ul>
					</div>
