		...
		<div className='grid grid-cols-2 gap-5 w-full'>
			...
			{connected &&
				(connectedLearnerToken || learnerReferenceUTxO?.data?.learnerInfo) && (
					<>
						<div className='card shadow-xl p-5 bg-secondary text-secondary-content rounded-lg drop-shadow'>
							<div>
								<div>
									<h2 className='text-2xl text-secondary-content font-mono pb-3'>
									...
									{learnerReferenceUTxO?.data?.learnerInfo ? (
										<>
											...
											<div className='bg-primary text-primary-content p-3 mb-3 rounded-lg drop-shadow'>
							...
							<div>
								<div>
									...
									<>
										...
										learnerReferenceUTxO?.data?.currentAssignment != "no" ? (
											<>
												<div className='p-3 bg-info mb-5 rounded-md drop-shadow'>
												...
												<Link
													className='btn rounded-lg drop-shadow text-primary-content'
