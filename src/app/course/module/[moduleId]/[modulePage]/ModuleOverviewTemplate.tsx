									...
									<div className='' key={page.slug}>
										{page.type != "ModuleOverview" && (
											<Link
												...
												<div className='hover:bg-info hover:rounded-lg hover:drop-shadow hover:scale-105 text-secondary-content p-3 mb-5'>
													<div className='mb-3 pb-1 border-b border-primary text-xl'>
														{page.title}
													</div>
