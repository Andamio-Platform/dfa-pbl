...
const BurnCourseModuleTokenModal = (props: {
		...
		<div>
			{connectedCourseCreator && (
				<>
					<button
						onClick={openModal}
						className='btn btn-error rounded-lg drop-shadow hover:bg-primary hover:text-primary-content hover:scale-105'
						type='button'>
						...
						content={
							<Suspense fallback={<Loading />}>
								<div className='text-sm'>
									...
									<p>
										Burning Module: {props.selectedModuleUTxO.data?.moduleId}
									</p>
									<BurnCourseModuleToken
