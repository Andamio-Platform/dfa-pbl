			...
			<>
				...
				<div className='flex flex-col p-10 bg-secondary'>
					...
					<div className='mb-4 text-base'>
						<p>
							An Andamio Learner Token allows you to commit to course
							assignments, and to create on-chain proof of what you have
							learned.
						</p>
					</div>
					<div className='mb-4 text-lg font-bold'>
						Choosing a &quot;Token Alias&quot;
					</div>
					<div className='mb-4 text-base'>
						<p>
							To mint an Andamio Learner Token, you must provide a name for your
							token. We call this your &quot;token alias&quot;. Some people
							choose to use their real name as a token alias, and others
							maintain privacy by using a different alias. Keep in mind that
							your token will be minted on the blockchain, where anyone can see
							it.
						</p>
					</div>
					<div className='py-5'>
