...
const UpdateLearnerDatum = (props: {
				...
				<div className='grid grid-cols-1 p-5 mx-auto'>
					<div className='md:col-span-2 p-5 mx-5 bg-secondary text-secondary-content rounded-lg drop-shadow'>
						...
						{props.learnerReferenceUTxO.data?.matchConnectedAddress ? (
							<div className='p-2 w-5/6 mx-auto mt-5 bg-success text-sm text-primary uppercase'>
								Connected Address matches on-chain address
							</div>
						) : (
							<div className='p-2 w-5/6 mx-auto mt-5 bg-error text-sm text-primary uppercase'>
					...
					<div className='p-2 mx-5'>
						...
						<p className='text-sm text-info font-bold pb-3'>
							Note: This transaction will change your address to the address of
						...
						<div className='mb-5'>
							<form>
								<input
									...
									className='bg-primary w-full my-2 p-2 text-primary-content font-mono text-base rounded-lg drop-shadow'
								/>
							</form>
						</div>
						<button
